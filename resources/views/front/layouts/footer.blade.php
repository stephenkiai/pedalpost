...
<footer class="footer bg-accent pt-5">
    <div class="container">
      <div class="row pb-2">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="widget widget-links widget-light pb-2 mb-4">
                ...
                <ul class="widget-list">
                    <li class="widget-list-item"><a class="widget-list-link" href="{{ route('home.about') }}">About </a></li>
                    <li class="widget-list-item"><a class="widget-list-link" href="{{ route('home.team') }}">Our Team</a></li>
                    <li class="widget-list-item"><a class="widget-list-link" href="{{ route('home.careers') }}">Careers</a></li>
                    <li class="widget-list-item"><a class="widget-list-link" href="{{ route('home.contact') }}">Contact Us</a></li>
                </ul>
            </div>
            ...
            <div class="widget widget-links widget-light pb-2 mb-4">
                ...
                <ul class="widget-list">
                    <li class="widget-list-item"><a class="widget-list-link" href="{{ route('home.policy') }}">User policies</a></li>
                    <li class="widget-list-item"><a class="widget-list-link" href="{{ route('home.terms') }}">Terms of Use</a></li>
      ...
      <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made by
          <a class="text-light" href="{{ route('home.index') }}">Wamoni</a></div>
    </div>
    </div>
  </footer>
